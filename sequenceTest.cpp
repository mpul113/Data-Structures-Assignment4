...
#include "sequence.h"
namespace seqOfDataTypes  = CS3358_FA2019_A04_sequenceOfDataTypes;
using namespace std;
...
template <class Item>
void show_list(seqOfDataTypes::sequence<Item> src);
// Pre: (none)
...
{
  seqOfDataTypes::sequence<double> s1;  // A sequence of double for testing
  seqOfDataTypes::sequence<char> s2; // A sequence of char for testing
